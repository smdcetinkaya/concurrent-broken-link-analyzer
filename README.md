...
Kullanıcı taramak istediği siteleri kaydedebilir

Tarama geçmişi saklanır

Uygulama kapatılıp yeniden açıldığında veriler korunur

Çoklu site yönetimi için yapılandırılmış bir sistem sunar
